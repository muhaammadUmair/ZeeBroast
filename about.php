...
<div class="section">
  <div class="container">
    ...
    <div class="value-grid">
      <div class="value-card"><div class="v-icon">✅</div><h4>100% Halal</h4><p>Certified halal ingredients in every dish we serve.</p></div>
      <div class="value-card"><div class="v-icon">👨‍🍳</div><h4>Freshly Prepared</h4><p>Made fresh daily, never frozen, never compromised.</p></div>
      <div class="value-card"><div class="v-icon">🚀</div><h4>Fast Delivery</h4><p>Hot food delivered to your doorstep in record time.</p></div>
      <div class="value-card"><div class="v-icon">⭐</div><h4>Best Quality</h4><p>Consistent quality and taste, order after order.</p></div>
    </div>
  </div>
</div>
